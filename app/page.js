      ...
      <div className="flex items-center justify-between w-full lg:flex-col">
        ...
        <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
          <AnimatedText
            ...
            className="!text-6xl !text-left lg:!text-center"
          />
          ...
          <div className="flex items-center self-start mt-2 lg:self-center">
            <Link
              href="/dummy.pdf"
              target="_blank"
              className="flex items-center bg-gray-900 text-gray-200 p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-gray-200 hover:text-gray-900 border-2 border-solid border-transparent animate-bounce hover:border-gray-900 md:p-2 md:px-4 md:text-base"
            >
              Resume <LinkArrow className="w-6 ml-1" />
            </Link>
            <Link
              href="/"
              className="flex items-center bg-gray-900 text-gray-200 p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-gray-200 hover:text-gray-900 border-2 border-solid border-transparent hover:border-gray-900 ml-4 md:p-2 md:px-4 md:text-base"
            >
              Hire Me
            </Link>
            <Link
