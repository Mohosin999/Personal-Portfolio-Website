...
const Hero = () => {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      <div className="w-11/12 h-full pt-24 flex items-center justify-center">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="hero_img_container w-full max-w-md bg-secondarycolor p-3 rounded-3xl border border-gray-600/[0.5] shadow-md">
            <img
              src="./img/hero.jpg"
              alt="profile_image"
       ...
       *                      Social links
       ======================================================== */}
      <div className="w-11/12 h-fit pt-10 pb-4 flex items-center justify-center gap-5">
        {/* Left section */}
        <div className="w-7/12 py-6 flex items-center justify-around bg-secondarycolor p-3 rounded-3xl border border-gray-600/[0.5] shadow-md">
          ...
          <div className="flex items-center justify-center gap-3 border-r-2 border-gray-400 w-full">
            <div className="font-bold text-5xl text-primarycolor">4+</div>
            <div>
          ...
          <div className="flex items-center justify-center w-full gap-3">
            <div className="font-bold text-5xl text-primarycolor">100+</div>
            <div>
              <h4 className="text-sm">
